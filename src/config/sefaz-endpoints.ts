...
export const ENDPOINTS_HOMOLOGACAO: Record<string, SefazEndpoints> = {
  ...
  'PR': {
    ...
    nfceConsulta: 'https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeConsultaProtocolo4',
    nfceStatusServico: 'https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeStatusServico4',
    nfceCancelamento: 'https://homologacao.nfce.sefa.pr.gov.br/nfce/NFeRecepcaoEvento4'
  },
  'RS': {
    nfceAutorizacao: 'https://nfce-homologacao.sefazrs.rs.gov.br/ws/NfeAutorizacao/NFeAutorizacao4.asmx',
    nfceConsulta: 'https://nfce-homologacao.sefazrs.rs.gov.br/ws/NfeConsulta/NfeConsulta4.asmx',
    nfceStatusServico: 'https://nfce-homologacao.sefazrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx',
    nfceCancelamento: 'https://nfce-homologacao.sefazrs.rs.gov.br/ws/recepcaoevento/recepcaoevento4.asmx'
  }
};
...
export const ENDPOINTS_PRODUCAO: Record<string, SefazEndpoints> = {
  ...
  'RS': {
    ...
    nfceConsulta: 'https://nfce.sefazrs.rs.gov.br/ws/NfeConsulta/NfeConsulta4.asmx',
    nfceStatusServico: 'https://nfce.sefazrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico4.asmx',
    nfceCancelamento: 'https://nfce.sefazrs.rs.gov.br/ws/recepcaoevento/recepcaoevento4.asmx'
  }
};
