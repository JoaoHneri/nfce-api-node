...
export const CONFIG_SOAP_POR_UF: Record<string, SOAPConfigPorOperacao> = {
    '35': { // SP
        autorizacao: {
            ...
            tagMsg: 'nfeDadosMsg',
            xmlnsTagMsg: 'xmlns="http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4"',
            namespaceCabecalho: 'http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4',
        },
        cancelamento: {
            protocoloSOAP: 'soap12',
    ...
    '41': { // PR
        autorizacao: {
            ...
            envelopePrefixo: 'soap',
            tagMsg: 'nfe:nfeDadosMsg',
            xmlnsTagMsg: 'xmlns:nfe="http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4"',
            namespaceCabecalho: 'http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4',
        },
        cancelamento: {
            protocoloSOAP: 'soap',
            envelopePrefixo: 'soap',
            tagMsg: 'nfe:nfeDadosMsg',
            xmlnsTagMsg: 'xmlns:nfe="http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento4"',
        }
    },
    '43': { // RS
        autorizacao: {
